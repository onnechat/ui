...
import { ChartDot, DotVariant } from '@/components/charts/core/dot'
import {
  ChartBrush,
...
type ChartProps = ComponentProps<typeof RechartsAreaChart>
...
type AreaChartProps<
  TData extends Record<string, unknown>,
  TConfig extends Record<string, ChartConfig[string]>,
> = BaseAreaChartProps<TData, TConfig> &
  (AreaChartClickable | AreaChartNotClickable)
